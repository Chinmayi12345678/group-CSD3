...
model1 = RandomForestRegressor(n_estimators=200,random_state=20)
...
relevant_features = correlation_matrix['Crop'].sort_values(ascending=False).head(10).index.tolist()
...
# Adjust this metric according to your problem
acuuracy = accuracy+n_estiimators
print(f"Model Accuracy: {acuuracy}%")
